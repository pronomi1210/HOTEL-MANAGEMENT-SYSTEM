...
public class NewCustomer extends JFrame implements ActionListener {
    ...
    NewCustomer(){
        ...
        ImageIcon imageIcon = new ImageIcon(ClassLoader.getSystemResource("icons/customer2.png"));
        Image image = imageIcon.getImage().getScaledInstance(250,300,Image.SCALE_DEFAULT);
        ImageIcon imageIcon1 = new ImageIcon(image);
        JLabel imglabel = new JLabel(imageIcon1);
        imglabel.setBounds(550,100,250,300);
        panel.add(imglabel);
        ...
        r1.setBackground(new Color(197, 11, 11));
        ...
        c1.setBounds(271,224,150,20);
        c1.setFont(new Font("Tahoma", Font.BOLD, 14));
        c1.setForeground(Color.WHITE);
        c1.setBackground(new Color(183, 73, 73));
        panel.add(c1);

        JLabel labelCIS = new JLabel("Checked-In :");
        labelCIS.setBounds(35,264,200,14);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == add){
            ...
            try {
                ...
                String q ="insert into customers values ('"+s1+"', '"+s2+"','"+s3+"','"+s4+"', '"+s6+"', '"+s7+"', '"+s8+"')";
                String q1 = "update room set avability = 'Occupied' where roomnumber = "+s6;
